...
type AiringTodayTvSeriesNavigationProp = NavigationProp<RootStackParam, 'TvSeriesDetail'>;
...
const AiringTodayTvSeries = () => {
    ...
    const {data = [], error, isFetching, isSuccess} = useAiringTodayTvSeriesApiQuery(page)
